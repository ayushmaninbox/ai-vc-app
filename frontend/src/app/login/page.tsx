        ...
        <div className="min-h-screen bg-[#fbf9f5] flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-10 mt-8">
                    ...
                    <h1 className="text-3xl font-serif text-[#1b1c1a] mb-2">Welcome back</h1>
                    <p className="text-[#55423e] font-body text-sm tracking-wide">Enter your details to sign in.</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-6">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                <label className="block font-label text-xs text-[#55423e] tracking-[0.1em]">Password</label>
                                <Link href="#" className="font-body text-xs text-[#9a442d] underline underline-offset-4 hover:text-[#e07a5f] transition-colors">Forgot?</Link>
                            </div>
                            <div className="relative">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="btn-primary w-full mt-2 flex justify-center items-center h-[52px]"
                        >
                ...
                <div className="text-center mt-10">
                    <p className="font-body text-[#55423e] text-sm">
                        ...
                        <Link href="/signup" className="text-[#9a442d] underline underline-offset-4 hover:text-[#e07a5f] font-semibold transition-colors">
                            Create one free
                        </Link>
                    </p>
                </div>
